...
```json
{
    ...
    "forward": {
        ...
        "items": [
            {
                "domain": "example.com",
                "url": "https://example.com?t=21321&sign=ewqeqw"
            }
        ]
    }
}
...
| &nbsp;&nbsp;&nbsp;&nbsp;├─ disableHttpChunk | boolean | 关闭 FLV Chunk 模式 | 必需 |
| &nbsp;&nbsp;&nbsp;&nbsp;├─ hlsType | integer | HLS 服务模式（0&1: 未使用, 2: 中心切片, 3: 边缘切片） | 必需 |
| &nbsp;&nbsp;&nbsp;&nbsp;├─ disablePublisherBattle | string | 是否开启抢流（默认 false 表示启用抢流） | 必需 |
| &nbsp;&nbsp;&nbsp;&nbsp;├─ enableBackupPublish | string | 是否开启主备流（默认 false 不开） | 必需 |
...
| enable | boolean | 是否启用 | 必需 |
| urlRewrites | []object | URL 改写规则 | 必需 |
| &nbsp;&nbsp;&nbsp;&nbsp;├─ pattern | string | 匹配规则（正则表达式） | 必需 |
| &nbsp;&nbsp;&nbsp;&nbsp;└─ replace | string | 改写规则 | 必需 |
| httpsEnable | boolean | 是否允许 HTTPS | 必需 |
| forward | object | 转推配置 | 必需 |
| &nbsp;&nbsp;&nbsp;&nbsp;├─ enable | boolean | 是否开启转推 | 必需 |
| &nbsp;&nbsp;&nbsp;&nbsp;└─ items | []object | 转推目标列表 | 必需 |
| &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;├─ domain | string | 转发到此域名 | 必需 |
| &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;└─ url | string | 转发到此 URL | 必需 |
| redirect | integer | 302 比例（<=0: 默认关闭；>0 时开启对应比例，如 50 表示 50%） | 可选 |
