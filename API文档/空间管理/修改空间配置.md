...
| recording | object | 可选 | 录制配置，[详见recording对象](#recording-object) |
| callbackUrl | string | 可选 | 回调地址 |
| callbackEnable | boolean | 可选 | 是否开启回调通知 |
| refererSecurity | object | 可选 | 防盗链配置，[详见refererSecurity对象](#referer-security-object) |
...
| segmentDuration | integer | 可选 | 录制切片时长,默认5s |
| snapshot | object | 可选 | 截图配置，[详见snapshot对象](#snapshot-object) |
...
| interval | integer | 可选 | 截图间隔,单位为s |
| filename | string | 可选 | 截图文件名模板 |
| format | string | 可选 | 参考(https://developer.qiniu.com/dora/8273/the-pipe): <br>vframe/jpg/offset/0<br>vframe/png/offset/0 |
