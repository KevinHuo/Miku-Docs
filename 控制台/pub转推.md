...
| **拉流地址** | 1. 支持直播/点播<br>2. 支持多个拉流地址<br>3. 支持指定运营商：默认/电信/移动/联通 | 1. 多个拉流地址会在前一个拉流结束后进入下一个（常用于点播）<br>3. 支持直播拉流：rtmp / flv / hls / rtsp<br>支持点播拉流：m3u8 / flv / mp4（视频编码需为 h.264/h.265，音频需为 AAC）<br>4. 只有点播类型任务支持播放次数设置 |
| **推流地址** | 1. 支持多个推流地址<br>2. 支持指定运营商 | 1. 多个推流地址会同时转推（计费按倍数计算）<br>3. 支持推流协议：rtmp / srt |
